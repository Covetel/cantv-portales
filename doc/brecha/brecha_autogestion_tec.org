#+TITLE:     Análisis de brecha Portal autogestión requerimientos técnicos
#+AUTHOR:    Carlos Paredes
#+EMAIL:     cparedes@covete.com.ve
#+DATE:      2014-1-16
#+DESCRIPTION: Análisis de brecha Portal autogestión requerimientos técnicos
#+KEYWORDS:
#+LANGUAGE:  es
...
* Autogestión Requerimientos Técnicos
...
*** Interface de usuario general / común
+ Nombre: Ayudas disponibles para usuarios finales.
...
*** Archiving
+ Nombre: Capacidad de especificar dinámicamente parámetros para almacenar
  archivos de datos.
...
*** Disponibilidad y redundancia
+ Nombre: Debe soportar todas las formas de tecnología de
  clustering. Clustering se refiere a un número formas en que un grupo de
...
*** Monitoreo
+ Nombre: Capacidad de logging y monitoreo.
...
*** Adaptación y configuración de sistemas
+ Nombre: Permitir la instalación del antivirus corporativo.
...
*** Monitoreo
+ Nombre: Soportae para herramientas de monitoreo automáticas.
...
*** Monitoreo
+ Nombre: Capacidades de "self-healing".
+ Descripción: Debe incluir capacidades de "self-healing". El sistema debe
  incluir "out of the box" la recuperación automática con acciones de "self
  healing" que corrijan problemas o fallas. Mensajes identificando los
  problemas y deberán haber acciones en progreso en logs y consolas
  operacionales.
+ Prioridad: Mandatorio
+ Esfuerzo: Funcionalidad no existente en Plone, se necesitan mas detalles o
  requiere de un fuerte desarrollo mayor a 32 horas
...
*** Disponibilidad y redundancia
+ Nombre: Soportar la recuperación automática luego de un evento de falla.
...
+ Descripción: Debe ser capaz de recuperar la aplicación en un tiempo
  específico dentro de las 24 horas.  El sistema deberá permitirle al
  administrador recuperar los componentes de aplicación y/o bases de datos en
  el sistema primario en un momento específico dentro de 24 horas.
+ Prioridad: Mandatorio
+ Esfuerzo: Funcionalidad no existente en Plone, se necesitan mas detalles o
  requiere de un fuerte desarrollo mayor a 32 horas
+ Aplicación que cubrirá la funcionalidad: Sistema de Gestión de Configuración
...
*** Consultas a otras  aplicaciones de CANTV
+ Nombre: Las consultas que se deban realizar desde la nueva plataforma a
  cualquier aplicación de CANTV se deben realizar a través de PIC.
...
+-----------------------------------------------+-----------+
|         Requieren desarrollo < 8 horas        |     15    |
+-----------------------------------------------+-----------+
|         Requieren desarrollo > 32 horas       |     58    |
+-----------------------------------------------+-----------+
|                No contempladas                |      9    |
+-----------------------------------------------+-----------+
#+END_DITAA
...
#+NAME: Funcionalidades
    [[./images/graph_brecha_autogestion_req_tec.png]]
\clearpage
